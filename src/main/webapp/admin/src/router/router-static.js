...
import center from '@/views/center'
    ...
    import discussdianyingshangcheng from '@/views/modules/discussdianyingshangcheng/list'
    import orders from '@/views/modules/orders/list'
    import dianyingfenlei from '@/views/modules/dianyingfenlei/list'
    import config from '@/views/modules/config/list'
    import dianyingshangcheng from '@/views/modules/dianyingshangcheng/list'
...
const routes = [{
	...
	path: '/shangpinfenlei',
      ...
      ,{
	path: '/discussdianyingshangcheng',
        name: '电影商城评论',
        component: discussdianyingshangcheng
      }
      ,{
        path: '/orders/:status',
        name: '订单管理',
	...
	path: '/config',
      ...
      ,{
	path: '/dianyingshangcheng',
        name: '电影商城',
        component: dianyingshangcheng
      }
    ]
  },
  {
