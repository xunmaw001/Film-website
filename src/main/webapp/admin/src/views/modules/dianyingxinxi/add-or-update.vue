<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="电影评分" prop="dianyingpingfen">
          <el-input v-model="ruleForm.dianyingpingfen" 
              placeholder="电影评分" clearable  :readonly="ro.dianyingpingfen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="电影评分" prop="dianyingpingfen">
              <el-input v-model="ruleForm.dianyingpingfen" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.dianyingmiaoshu = this.ruleForm.dianyingmiaoshu.replace(reg,'../../../ssm7u2ji/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
